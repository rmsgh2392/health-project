	...
	login_head : ()=>{
		return `
				...
				:root {
					...
					.bg-image {
					background-image: url('/web/resources/img/mainImage.jpg');
            ...
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <form>
                <div class="form-label-group">
                  <input type="text" id="userid" class="form-control"   placeholder="userid" value="yec125">
                ...
                <div class="text-center">
				  <a class="small" href="#">회원가입을 먼저 해주세요</a>
				</div>
              </form>
            </div>
          </div>
